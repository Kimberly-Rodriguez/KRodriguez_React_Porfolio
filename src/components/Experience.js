    ...
    <div className="resume-section-content">
        ...
        <div className="d-flex flex-column flex-md-row justify-content-between mb-5">
            <div className="flex-grow-1">
                ...
                <div className="subheading mb-3"> Office of Budget and Innovation, Office of the Mayor</div>
                <p>Built interactive community asset map with 250 strategic contacts for coalition building efforts.
              Managed four research fellows and served as interim team lead to complete team's foundational research.
            </p>
            </div>
            <div className="flex-shrink-0"><span className="text-primary">October 2016 - September 2017</span></div>
        </div>
